...
def undigraph(x): return x.replace("\u05f0", "וו").replace("\u05f1", "וי").replace(
    "\u05f2", "יי").replace("\ufb4f", "אל").replace("\u200d", "")
...
if __name__ == '__main__':
    ...
    parser.add_option(
        "-i", "--ie", help="input encoding [default %default]", dest="in_enc", default="utf-8")
    parser.add_option(
        "-o", "--oe", help="output encoding [default %default]", dest="out_enc", default="utf-8-sig")
